// This class is used to check and set the amount of bombs acquired from the TexField in New Game Modal
package minesweeper;
...
public class BombsTextField extends TextField {

	// BooleanProperty which is used for binding and helps for listening for changes in the TextFields
	public BooleanProperty valid = new SimpleBooleanProperty();

	/**
	 * This Constructor takes in a String Value and sends the string variable to the constructor in the superclass and inherits all the public methods of the super class
	 * @param string A String Value
	 */
	public BombsTextField(String string) {
	...
	private void validate() {
		...
		// Only allows two digit numbers from 0-9
		if (getText().matches("[0-9]{2}+")) {
